  ...
  module Acts
    module Authorizable
      ...
      module AuthSingletonMethods
        #Piggybacks an existing association to a user to look for data_permissions. Optionally takes either a hard-code role or a role association.
        ...
        #Piggybacks an existing belongs_to association to look for data_permissions.
        ...
        #Piggybacks an existing has_one association to look for data_permissions.
        def auth_has_one_parent(assoc,options = {})
          auth_belongs_to_parent(assoc,options)
        end
        
        #Piggybacks an existing has_many association to look for data_permissions. Optionally takes a scope which takes the user object as a parameter which weeds the has_many association.
